...
export RASSINE_ROOT_PATH=/home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03
...
python dace_extract_filenames.py "$dace_table" | parallel --verbose -N$nchunks_preprocess --jobs $nthreads_preprocess --keep-order python rassine_preprocess.py -i HARPS -o "$output_dir"

exit
## Match frame (Borders)
# This was python Rassine_multiprocessed.py -v MATCHING -s /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/PREPROCESSED/ -n $nthreads_matching -d $dlambda -k /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/DACE_TABLE/Dace_extracted_table.csv
...
# This was python Rassine_multiprocessed.py -v RASSINE -s /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED/Stacked -n $nthreads_rassine -l "$rassine_master" -P True -e False
...
output_dir=/home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED
ls /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED/Stacked*.p | parallel --jobs $nthreads_rassine --keep-order python Rassine.py -o $output_dir -a False -P True -e False -l $rassine_master -s


## Intersect continuum
# This was python Rassine_multiprocessed.py -v INTERSECT -s /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED/RASSINE -n $nthreads_intersect

# TODO: rassine_anchor_scan.py
# TODO: rassine_anchor_filter.py
# Step 5A: computation of the parameters
# See Fig D7
python rassine_intersect1.py --input-directory /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED --feedback $not_full_auto --no-master-spectrum --copies-master 0 --kind anchor_index --nthreads $nthreads_intersect1 --fraction 0.2 --threshold 0.66 --tolerance 0.5 --add-new True

# Step 5B: application in parallel
# Done in place
# "matching_anchor"
ls /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED/RASSINE* | parallel -N$nchunks_intersect2 --jobs $nthreads_intersect2 --keep-order python rassine_intersect2.py
...
output_savgol_window=/home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/savgol_window.txt
python rassine_matching_diff_continuum_sphinx.py --input_directory /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED --output-file $output_savgol_window --no-master
savgol_window=$(< $output_savgol_window)

# Step 6B done in parallel
# "matching_diff"
ls /home/denis/w/rassine/spectra_library/HD23249/data/s1d/HARPS03/STACKED/RASSINE* | parallel -N$nchunks_savgol --jobs $nthreads_savgol --keep-order python rassine_savgol.py --anchor-file $rassine_master --savgol-window $savgol_window
